...
for UNCERTAINTY_METHOD in temp_scaling label_smoothing MonteCarlo inhibited evidential1 evidential2 bayesian ensembles trustscore model_calibration; do
